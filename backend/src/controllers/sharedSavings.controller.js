...
export const createSharedSavings = async (req, res) => {
    ...
    return success(
        res,
        "Tabungan bersama berhasil dibuat.",
        result,
        201
    );
};
...
export const getSharedSavings = async (req, res) => {
    ...
    return success(
        res,
        "Data tabungan bersama berhasil diambil.",
        result
    );
};
...
export const getSharedSavingsById = async (req, res) => {
    ...
    return success(
        res,
        "Detail tabungan bersama berhasil diambil.",
...
export const updateSharedSavings = async (req, res) => {
    ...
    return success(
        res,
        "Tabungan bersama berhasil diperbarui.",
        { shared_savings: sharedSavings }
    );
};
...
export const deleteSharedSavings = async (req, res) => {
    ...
    return success(
        res,
        "Tabungan bersama berhasil dihapus."
    );
};
...
export const joinSharedSavings = async (req, res) => {
    ...
    return success(
        res,
        "Berhasil bergabung ke tabungan bersama.",
        result
    );
};
...
export const getSharedSavingsMembers = async (req, res) => {
    ...
    return success(
        res,
        "Daftar member tabungan bersama berhasil diambil.",
        result
    );
};
...
export const createSharedTransaction = async (req, res) => {
    ...
    return success(
        res,
        "Transaksi tabungan bersama berhasil dicatat.",
        result,
        201
    );
};
...
export const updateSharedTransaction = async (req, res) => {
    ...
    return success(
        res,
        "Transaksi tabungan bersama berhasil diperbarui.",
        result
    );
};
...
export const deleteSharedTransaction = async (req, res) => {
    ...
    return success(
        res,
        "Transaksi tabungan bersama berhasil dihapus.",
        result
    );
};
...
export const getSharedSavingsStatistics = async (req, res) => {
    ...
    return success(
        res,
        "Statistik tabungan bersama berhasil diambil.",
        result
    );
};
